...
class IDLRoutine(object):
    ...
    def __call__(self, *args, **kw):
        #print "call: %s%s%s" % (self.fn, args, kw)
    ...
    def __getattr__(self, attr):
        ...
        def wrapper(*args, **kw):
            print "wrapper: %s%s%s" % (attr, args, kw)
...
# create wrapper object called OMINAS
# all OMINAS methods will be wrapped as needed, including arrays of objects
OMINAS=IDL.objarrw(1)
